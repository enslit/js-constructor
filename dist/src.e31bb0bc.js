...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/empty.jpg":[function(require,module,exports) {
module.exports = "/empty.683e717f.jpg";
...
var ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" alt=").concat(alt, " style=\"").concat((0, _utils.css)(s), "\" />"), (0, _utils.css)(styles));
    }
  }]);
...
var _empty = _interopRequireDefault(require("./assets/empty.jpg"));

var _blocks = require("./classes/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('Конструктор сайтов на JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ImageBlock(_empty.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
  ...
  alt: 'картинка'
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'Изучаю принципы SOLID и ООП в JavaScript', 'JavaScript - это просто, интересно'], {
  styles: {
...
}), new _blocks.TextBlock('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, reiciendis!', {
  styles: {
...
exports.model = model;
},{"./assets/empty.jpg":"assets/empty.jpg","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
...
},{"./styles/main.scss":"styles/main.scss","./model":"model.js","./classes/app":"classes/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
